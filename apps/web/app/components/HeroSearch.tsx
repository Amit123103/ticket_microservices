      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mx-auto max-w-3xl text-center mb-10">
          <div className="section-pill mb-3">
            <Icons.sparkles className="h-3.5 w-3.5 text-orange-500" /> Instant Booking & Zero Cancellation Fee Option
          </div>
        ...
        {/* Search Form Card */}
        <form onSubmit={onSearch} className="relative z-10 rounded-3xl border border-stone-200 bg-white p-6 sm:p-8 shadow-xl shadow-stone-200/50">
          {/* Top Options */}
          <div className="mb-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pb-5 border-b border-stone-100">
            <div className="flex items-center gap-6">
              <label className="flex cursor-pointer items-center gap-2 text-sm font-semibold text-orange-600">
                <input type="radio" name="triptype" defaultChecked className="h-4 w-4 accent-orange-500" /> One Way
              </label>
              <label className="flex cursor-pointer items-center gap-2 text-sm font-medium text-stone-400 hover:text-stone-700">
                <input type="radio" name="triptype" className="h-4 w-4 accent-orange-500" /> Round Trip
              </label>
            </div>
            <div className="flex flex-wrap items-center gap-2">
              <span className="text-xs font-bold uppercase tracking-wider text-stone-400">Quota:</span>
          ...
          <div className="grid gap-5 lg:grid-cols-[1.2fr_auto_1.2fr_1fr_0.9fr_1fr]">
            {/* From */}
            <div className="rounded-2xl border border-stone-200 bg-white p-4 transition-all hover:border-orange-200 hover:shadow-sm">
            ...
            <div className="flex items-center justify-center">
              <button
                ...
                onClick={switchRoute}
                title="Swap stations"
                className="grid h-11 w-11 place-items-center rounded-xl border border-orange-200 bg-orange-50 text-orange-500 transition-all hover:bg-orange-500 hover:text-white hover:rotate-180"
              >
            ...
            {/* Date */}
            <div className="rounded-2xl border border-stone-200 bg-white p-4 transition-all hover:border-indigo-200 hover:shadow-sm">
        ...
        <div className="mt-8 grid grid-cols-2 gap-4 text-center sm:grid-cols-4">
          {[
            ...
            <div key={i} className="rounded-2xl border border-stone-200 bg-white p-5 flex flex-col items-center justify-center shadow-sm hover:shadow-md transition-all">
              <Icons.train className="h-6 w-6 text-orange-500" />
