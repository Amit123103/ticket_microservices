      ...
      <header className="sticky top-0 z-50 border-b border-purple-100 bg-white/90 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3.5 sm:px-6">
          ...
          <div className="flex items-center gap-3">
            <button
              onClick={onLogin}
              className="text-xs font-bold text-stone-600 hover:text-purple-600 px-3.5 py-2 rounded-xl hover:bg-purple-50 transition-all"
            >
              Log in
            </button>
            <button
              onClick={onLogin}
              className="btn-brand text-xs px-4 py-2 rounded-xl"
            >
              Get Started
            </button>
          </div>
