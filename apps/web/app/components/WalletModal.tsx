    ...
    <div className="modal-overlay">
      <div className="relative w-full max-w-md rounded-3xl border border-stone-200 bg-white shadow-2xl animate-scale-in overflow-hidden">
        ...
        <div className="p-6 space-y-6">
          <div className="rounded-2xl bg-gradient-to-br from-purple-600 to-violet-600 p-6 text-white shadow-lg shadow-purple-500/20">
            <span className="text-xs font-bold uppercase tracking-widest text-purple-100">Available Balance</span>
